<template>
  <div class="min-h-screen bg-gray-100 text-gray-800 p-6">
    <div class="max-w-4xl mx-auto">
      <h1 class="text-3xl font-bold mb-6 text-center">BudgetWise</h1>
...
export default {
  ...
  methods: {
      ...
      const res = await fetch(`https://budgetwise-rill.onrender.com/api/expenses?${params}`);
      this.expenses = await res.json();
    },
    async fetchRevenues() {
      const res = await fetch('https://budgetwise-rill.onrender.com/api/revenues');
      this.revenues = await res.json();
    },
    async fetchExpenses() {
      const res = await fetch('https://budgetwise-rill.onrender.com/api/expenses');
      this.expenses = await res.json();
    },
    onRevenueAdded() {
    ...
    async deleteRevenue(id) {
      ...
      try {
        const response = await fetch(`https://budgetwise-rill.onrender.com/api/revenues/${id}`, {
          method: 'DELETE'
        });
    ...
    async deleteExpense(id) {
      ...
      try {
        const response = await fetch(`https://budgetwise-rill.onrender.com/api/expenses/${id}`, {
          method: 'DELETE'
        });
    ...
    async submitBudget() {
      try {
        const res = await fetch('https://budgetwise-rill.onrender.com/api/budget', {
          method: 'POST',
  ...
  async fetchMonthlyBudget() {
    try {
      ...
      const url = `https://budgetwise-rill.onrender.com/api/budget/${month}`;
